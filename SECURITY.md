...
Genomics Kitchen processes files locally in the browser. Sequence data are not uploaded to a server, and the app has no backend, no tracking, no analytics, and no hidden network calls.
